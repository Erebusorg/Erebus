...
three hops. The registry contract and the shielded fee pool are not built, and no
public network is running — everything runs against a devnet you start yourself.
